...
/**
 * The <code>IntProcedureEntriesList</code> class provides an implementation of an <code>IntProcedure</code> and records node id's from its
 * execution in a list.<br />
 * <br />
 * Simply pass an instance of this class to an rtree search and access the retrieved nodes' indices with {@link #get(int)} and
...
public class IntProcedureEntriesList implements IntProcedure {
	...
	/**
	 * Caches the id passed from the calling method to the list. This method is utilized primarily for the purpose of rtree searches and is
