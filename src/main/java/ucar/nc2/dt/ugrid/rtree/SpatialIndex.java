...
public interface SpatialIndex {
	...
	/**
	 * Initializes any implementation dependent properties of the spatial index. For example, RTree implementations will have a NodeSize
	 * property.
	 * 
	 * @param props
	 ...
	 * @param id
	 *            The ID of the polygon to add to the spatial index. The result of adding more than one polygon with the same ID is
	 *            undefined.
	 */
	 ...
	 * 
	 * @return <code>true</code> if the polygon was deleted, <code>false</code> if the polygon was not found, or the polygon was found but
	 *         with a different ID
	 */
	...
	/**
	 * Finds the polygon which is nearest to the passed point, and calls apply() on the passed IntProcedure for each one. If multiple
	 ...
	 * 
	 *            Use Double.POSITIVE_INFINITY to guarantee that the nearest polygon is found, no matter how far away, although this will
