...
/**
 * The <code>IntProcedureEntriesStack</code> class provides an implementation of an <code>IntProcedure</code> and records node id's from its
 * execution in a stack.<br />
 * <br />
 * Simply pass an instance of this class to an rtree search and access the retrieved node indices with {@link #peek()}, {@link #peek(int)},
...
public class IntProcedureEntriesStack implements IntProcedure {
	...
	/**
	 * Caches the id passed from the calling method to the stack. This method is utilized primarily for the purpose of rtree searches and is
	...
	/**
	 * Removes all items from this stack. Use {@link #clear()} instead, if the values returned by this methods invokation are not going to
	 * be used.
	 * 
	...
	/**
	 * Removes all of the elements from this stack (optional operation). This list will be empty after this call returns (unless it throws
	 * an exception).
	 * 
