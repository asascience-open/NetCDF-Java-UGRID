...
public class AsaUnits {
	...
	public enum SpeedType {
		 ...
		 */
		UNKNOWN(1, 1, "unknown"), KNOTS(0.514444444, 1.94384449, "kt"), METERS_SEC(1, 1, "m/s"), MILLIMETERS_SEC(0.001, 1000, "mm/s"),
		CENTIMETERS_SEC(0.01, 100, "cm/s"), MILES_HOUR(0.44704, 2.23693629, "mph"), KILOMETERS_HOUR(0.277777778, 3.6, "km/h");
		...
		/**
		 * @return the number of meters equal to <code>n</code> when <code>n</code> is in the units specified by this enumeration
		 */
	...
	public enum DistanceType {
		UNKNOWN(1, 1, "unknown"), METERS(1, 1, "m"), KILOMETERS(1000, 0.001, "km"), MILES(1609.344, 0.000621371192, "mi"), FEET(0.3048,
			3.2808399, "ft"), NAUTICAL_MILES(1852, 0.000539, "nm");
	...
	public enum MassType {
		GRAM(1, 1, "g"), KILOGRAM(1000, 0.001, "kg"), USTON(907184.74, 0.000001102311310924, "ton (US Short)"), LBS(453.59237,
			0.002204622621849, "lbs");
		...
		/**
		 * @return the number of grams equal to <code>n</code> when <code>n</code> is in the units specified by this enumeration
		 */
	...
	/**
	 * Converts the given <code>speed</code> from the units <code>fromUnits</code> to the units specified by <code>toUnit</code>
	 * 
	 * @param fromUnits
	...
	/**
	 * Converts the given <code>speed</code> array from the units <code>fromUnits</code> to the units specified by <code>toUnit</code>
	 * 
	 * @param fromUnits
	 *            an enumeration specifying the unit type of <code>speed</code>
	 * @param toUnits
	...
	/**
	 * Converts the given <code>distance</code> from the units <code>fromUnits</code> to the units specified by <code>toUnit</code>
	 * 
	 * @param fromUnits
	...
	/**
	 * Converts the given <code>distance</code> array from the units <code>fromUnits</code> to the units specified by <code>toUnit</code>
	 * 
	 * @param fromUnits
	 *            an enumeration specifying the unit type of <code>distance</code>
	 * @param toUnits
