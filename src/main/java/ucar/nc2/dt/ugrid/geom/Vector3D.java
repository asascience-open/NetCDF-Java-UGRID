 ...
 * <p>
 * The class also provides methods to perform mathematical operations on this and other vectors (addition, subtraction, multiplication,
...
public class Vector3D {
	...
	/**
	 * Gets the <code>Point3D</code> indicated by applying the vector {@code (u, v, w)} components to the <code>origin</code>
	 * <p>
	 ...
	 *            the second <code>Vector3D</code>
	 * 
	 * @return a <code>Vector3D</code> which is perpendicular to the plane containing the given vector's. i.e. Cross product.
	 */
	public static Vector3D cross(Vector3D v1, Vector3D v2) {
		// TODO: what orientation does this represent, and does it matter??
		// should this clarification be in the above javadoc??
		return (new Vector3D(v1.getV() * v2.getW() - v1.getW() * v2.getV(), v1.getW() * v2.getU() - v1.getU() * v2.getW(), v1.getU()
			* v2.getV() - v1.getV() * v2.getU()));
	}
