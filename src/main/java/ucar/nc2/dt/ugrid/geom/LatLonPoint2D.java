...
public abstract class LatLonPoint2D extends Point2D implements Serializable {
	...
	/**
	 * Factory method that will create a LatLonPoint2D.Float from a Point2D object. If pt2D is already a LatLonPoint2D.Float object, it is
	 * simply returned.
	 * 
	 * @param pt2D
	...
	/**
	 * Factory method that will create a LatLonPoint2D.Double from a Point2D object. If pt2D is already a LatLonPoint2D.Double object, it is
	 * simply returned.
	 * 
	 * @param pt2D
	...
	public boolean equals(Object obj) {
		if (obj instanceof LatLonPoint2D) {
			...
			return (AsaMath.almostEqual(getY(), pt.getY(), EQUIVALENT_TOLERANCE) && AsaMath.almostEqual(getX(), pt.getX(),
